...
P.S. На Linux при копировании папки CMSIS с интернета возможно слетят настройки прав доступа к файлам и каталогам. Исправить это просто командой "chmod -R 777 CMSIS" (при условии, что вы запустили скрипт в папке CMSIS_PROJECT_CREATOR)
